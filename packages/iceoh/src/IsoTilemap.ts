...
export class IsoTilemap<T> extends Tilemap<T> {
   ...
   * @type {IPoint}
   */
  public readonly baseOrigin: IPoint;
  /**
   ...
   * @type {number}
   */
  public readonly baseSurfaceHeight: number;
  /**
   ...
   * @type {number}
   */
  public readonly baseSurfaceHalfHeight: number;
  /**
   ...
   */
  public tileDimensions: MapThree<ExtendedBox<T>> = new Map();
